...
const UserManagement = () => {
    ...
    const { loading, users, addUser, updateUser, deleteUser, fetchUsers } = useContext(AdminContext);
    ...
    <div className='max-w-7xl mx-auto p-6'>
        ...
        <div className="p-6 rounded-lg mb-6">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type='submit' className='cursor-pointer bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600'>Add user</button>
            </form>
        </div>
